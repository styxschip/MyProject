...
typedef struct _tagIDT 
{
    ...
    unsigned __int64 m_DPL:   2;
    unsigned __int64 m_P:     1;
    unsigned __int64 m_OffsetHigh: 16;
}IDT, *PIDT;
#pragma pack(pop)
...
public:
    ...
    static DWORD GetBaseFormGDT(PGDT pValue, DWORD *pdwBase);
    static DWORD GetLimiteFormGDT(PGDT pValue, DWORD *pwLimite);
    ...
    //IDT中获取函数地址
    static DWORD GetOffsetFormIDT(PIDT pValue, DWORD *pdwOffset);
